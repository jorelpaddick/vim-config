...
if &t_Co > 255
   if s:molokai_original == 1
      ...
      hi Normal       ctermfg=157 ctermbg=233
      hi CursorLine               ctermbg=22     cterm=none
      hi CursorLineNr ctermfg=208                cterm=none
   endif
   ...
   " Markdown Specific Color items
   hi markdownH1            ctermfg=196
   hi markdownH2            ctermfg=51
   hi markdownH3            ctermfg=82
   hi markdownH4            ctermfg=202
   hi markdownH5            ctermfg=226
   hi markdownH6            ctermfg=207
   hi markdownHeadingRule   ctermfg=196
   hi markdownListMarker    ctermfg=118
   ...
   hi SpecialComment  ctermfg=85               cterm=bold
   ...
   hi Statement       ctermfg=226               cterm=bold
